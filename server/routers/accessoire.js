...
router.route('/updateOneAccessories/:_id').put(accessoire.update_one_accessories);

router.route('/deleteOneAccessories/:_id').delete(accessoire.delete_one_accessories);
