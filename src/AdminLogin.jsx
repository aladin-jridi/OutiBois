...
const AdminLogin = (props) => {
     ...
     <div className="login">
          ...
          <div className="contact">
               ...
               <input value={signin.username} onChange={(e) => setSignin({ ...signin, username: e.target.value })} 
               name="username" placeholder="username" type="text" />
               <input value={signin.password} onChange={(e) => setSignin({ ...signin, password: e.target.value })} 
