      ...
      <header id="navbar-spy" className="transparent-header">
        <nav id="primary-menu" className="navbar navbar-fixed-top style-1">
          <div className="container navbar-logo-shop-card">
            ...
            >
              {/* .module-cart */}
              <ShopCard shopcard={shopcard} removeFromCard={removeFromCard} />
              {/* .module-cart end */}
            </div>
            {/* /.navbar-collapse */}
          </div>
          ...
          <div id="slider1" className="rev_slider" data-version={5.0}>
            <ul>
              ...
              >
                ...
                >
                  Notre promesse en tant que fournisseur est de garantir la
                  qualité de nos produits à des prix imbattables.
                  <br />
                  tout en offrant une expérience professionnelle.
                </div>
                {/* LAYER NR. 4 */}
                <div
                  className="tp-caption"
                  ...
                  style={{
                    fontFamily: "raleway",
                    backgroundColor: "rgba(255, 197, 39, 0.8)",
                    textAlign: "center",
                  }}
                >
                  <img
              ...
              >
                ...
                >
                  <b>OUTIEBOIS</b> vous offre une large gamme de produits de
                  qualité assurant à ses clients efficacité, Sécurité et
                  confort.
                  <br />
              ...
              >
                ...
                >
                  Nous disposons d'une équipe de spécialistes capables de
                  maximiser le résultat et de délivrer les produits.
                </div>
                {/* LAYER NR. 4 */}
                <div
                  className="tp-caption"
            ...
            {current.map((machine, index) => (
              ...
              >
                ...
                <div className="product-bio">
                  ...
                  <p className="product-price">{/* {machine.discription} */}</p>
                </div>
                <video
        ...
        <div className="container info-section-map-section">
          ...
          <div className="row">
            <div className="widget-about-info" id="textmap">
              ...
              <h4>
                <p className="mb-0">
                  La société OutiBois a été crée en 2002, spécialiste et leader
                  dans la vente, réparation des machines a bois et outillages
                  industriels neuf et occasion. La société OutiBois vous offre
                  une large gamme de produit exposé sur plus de 1000m². Fort de
                  notre expérience de plus de 40 ans dans la machinerie a bois,
                  Nous sommes a l’écoute de nos clients .Nous leurs assurons bon
