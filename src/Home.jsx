          ...
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-12 col-md-12 shop-filter">
              <ul className="list-inline">
                ...
                >
                  <a className={active.filter1} data-filter="*">
                    Nouvelle Machine
                  </a>
                </li>
                <li
                ...
                >
                  <a className={active.filter2} data-filter=".filter-best">
                    Ancienne Machine
                  </a>
                </li>
                <li
                ...
                >
                  <a className={active.filter3} data-filter=".filter-featured">
                    Outiage
                  </a>
                </li>
                <li
                ...
                >
                  <a className={active.filter4} data-filter=".filter-sale">
                    En Promotion
                  </a>
                </li>
              </ul>
